...
Window::Window(const int& width, const int& height) :
        game_window(std::make_shared<SDL2pp::Window>("Worms2D", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
...
void Window::render_stage_texture(std::shared_ptr<SDL2pp::Texture>& texture, SDL2pp::Rect destination) {
...
void Window::clear_textures() {
    game_renderer->Clear();
}

void Window::present_textures() {
...
void Window::render_stage(TexturesPool& pool) {
    ...
    render_stage_texture(pool.get_texture(Actors::GRADIENT),
