...
public:
    Crate(std::shared_ptr<CrateState>& initial_state, TexturesPool& pool,
            ...
            still_falling(true), was_opened(false){}
...
private:
    Animation opening;
public:
    TrapCrate(std::shared_ptr<CrateState>& initial_state, TexturesPool& pool,
          Camera& camera) :
...
private:
    Animation opening;
public:
    HealCrate(std::shared_ptr<CrateState>& initial_state, TexturesPool& pool,
              Camera& camera) :
            Crate(initial_state, pool, camera),
...
private:
    Animation opening;
public:
    AmmoCrate(std::shared_ptr<CrateState>& initial_state, TexturesPool& pool,
              Camera& camera) :
            Crate(initial_state, pool, camera),
